...
BLOG_EMAIL = "rse@sheffield.ac.uk"
BLOG_DESCRIPTION = "RSE at Sheffield"  # (translatable)
...
# Primary color of your theme. This will be used to customize your theme. Must be a HEX value.
THEME_COLOR = '#5670d4'
